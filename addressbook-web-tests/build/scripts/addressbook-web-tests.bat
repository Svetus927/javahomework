...
set CLASSPATH=%APP_HOME%\lib\testng-6.11.jar;%APP_HOME%\lib\snakeyaml-1.17.jar;%APP_HOME%\lib\addressbook-web-tests-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jcommander-1.64.jar

@rem Execute addressbook-web-tests
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ADDRESSBOOK_WEB_TESTS_OPTS%  -classpath "%CLASSPATH%" myFirstTest %CMD_LINE_ARGS%
